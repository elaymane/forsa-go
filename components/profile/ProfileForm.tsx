...
export default function ProfileForm({ user }: { user: User }) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        <label className={labelClass}>Your level</label>
      ...
      <div>
        <label className={labelClass}>Your specialization / تخصص</label>
        <input
          name="specialization"
      ...
      <p className="text-xs text-gray-400">
        We use this to mark opportunities that match your profile with a badge — it's never required
        to apply.
      </p>
