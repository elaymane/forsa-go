...
import { X, Sun, Moon, MessageCircle, Crown } from "lucide-react";
    ...
    <>
      ...
      <div className="p-4">
        <div className="mb-10 flex items-center justify-between">
          <div className={`flex items-center gap-3 ${open ? "" : "w-full justify-center"}`}>
            {open && (
              <button
                onClick={onToggle}
            ...
            <button
              ...
              className={`relative flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-xl ${
                open ? "" : "cursor-pointer transition hover:opacity-90"
              }`}
            >
              <Image src="/logo-icon.png" alt="Forsa Go" fill sizes="44px" className="object-cover" />
            </button>
        ...
        {open && (
          <div className="mt-2">
            <ReportProblemButton label="Report a problem" />
          </div>
        )}
      </div>
