      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex min-w-0 items-center gap-3">
          <button
            ...
            className="shrink-0 rounded-lg bg-black/5 p-2 transition hover:bg-black/10 dark:bg-white/5 dark:hover:bg-white/10 md:hidden"
          >
            <MenuIcon size={18} />
          </button>
          <div className="min-w-0">
            {heading && <h1 className="truncate text-lg font-semibold text-gray-900 dark:text-white">{heading}</h1>}
            ...
            <AnimatePresence>
              {openNotif && (
                <motion.div
                  ...
                  className="fixed inset-x-4 top-20 z-50 overflow-hidden rounded-3xl border border-black/10 bg-white shadow-2xl dark:border-white/10 dark:bg-[#0B1220] sm:absolute sm:inset-x-auto sm:right-0 sm:top-auto sm:mt-3 sm:w-[380px]"
                >
