  ...
  return (
    <div>
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h2 className="text-xl font-semibold sm:text-2xl">🚨 New Opportunities</h2>
      ...
      {visible.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-black/10 p-10 text-center text-sm text-gray-500 dark:border-white/10 dark:text-gray-400">
          No {filter.toLowerCase()} opportunities right now — check back soon.
        </div>
      ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-3 top-3 flex flex-col gap-1">
                    ...
                    {offer.level && <Badge tone="neutral">{offer.level}</Badge>}
                  </div>
                  ...
                  <div className="px-4 pb-4 text-center">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      >
                        <Send size={12} /> {applied ? "Applied" : "Apply"}
                      </button>
                      <button
