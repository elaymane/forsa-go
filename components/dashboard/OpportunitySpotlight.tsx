...
export default function OpportunitySpotlight({ opportunities, applicationsMap }: OpportunitySpotlightProps) {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold sm:text-2xl">⚡ Take Action Now</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400">Focus before deadlines hit</p>
        </div>
