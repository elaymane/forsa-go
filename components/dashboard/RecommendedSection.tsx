    ...
    return (
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="font-semibold">Get opportunities matched to you</p>
          <p className="text-xs text-gray-500 dark:text-gray-400">
            Set your level and specialization in your profile — takes 10 seconds.
          </p>
        </div>
  ...
  if (recommended.length === 0) {
    return (
      <div className="rounded-3xl border border-dashed border-black/10 p-5 text-sm text-gray-500 dark:border-white/10 dark:text-gray-400">
        No opportunities match your profile yet — check back as new ones are added.
      </div>
    );
  }
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">Matches your profile</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {recommended.map((offer) => (
          <button
            ...
            className="group overflow-hidden rounded-2xl border border-purple-200/60 bg-gradient-to-b from-purple-50/60 to-white text-left transition hover:-translate-y-1 hover:shadow-lg dark:border-purple-500/20 dark:from-purple-500/[0.06] dark:to-white/5"
          >
            <div className="flex h-24 items-center justify-center bg-black/[0.02] dark:bg-white/[0.03]">
              <img src={offer.image} alt={offer.title} loading="lazy" decoding="async" className="h-14 w-14 object-contain transition group-hover:scale-110" />
            </div>
            <div className="p-3">
