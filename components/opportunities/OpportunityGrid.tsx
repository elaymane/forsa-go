...
export default function OpportunityGrid({ offers, applicationsMap, userProfile, guestMode, locale, viewCounts }: OpportunityGridProps) {
  const i = t(locale).opportunityGrid;
  ...
  return (
    <div className="space-y-6">
      <div className="mt-2 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h1 className="text-lg font-semibold">{i.latestOpportunities}</h1>
      ...
      {currentOffers.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-[#E2E8F0] p-16 text-center dark:border-white/10">
          <p className="font-medium">{i.noMatch}</p>
