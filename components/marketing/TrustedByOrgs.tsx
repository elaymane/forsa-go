        ...
        <div className="flex flex-wrap items-center justify-between gap-x-6 gap-y-5">
          {top.map((org) => (
            <Link
              ...
              className="flex items-center gap-2.5 grayscale transition hover:grayscale-0"
            >
              <img src={org.image} alt={`Logo ${org.name}`} loading="lazy" decoding="async" className="h-10 w-10 rounded-md object-cover" />
