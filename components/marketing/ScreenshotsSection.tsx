...
const EXPECTED_FILES = [
  ...
  { file: "opportunities.png", label: "Opportunities" },
  { file: "applications.png", label: "Applications" },
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {available.map((item) => (
            ...
            >
              <img src={`/screenshots/${item.file}`} alt={item.label} loading="lazy" decoding="async" className="w-full" />
